  ...
  return (
    <div className="relative " ref={dropdownRef}>
      {/* <button
          ...
          className="px-4 py-2 text-gray-800 bg-green-500 hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-400 "
        >
          {label}
        </button> */}
      ...
      <div
        onClick={toggleDropdown}
        className="flex items-center h-12 px-5 rounded-full bg-transparent  gap-2 hover:bg-hoverBg duration-300 cursor-pointer"
      >
...
export default DeptDropdownMenu;
