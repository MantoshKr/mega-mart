    ...
    sublinks: [
      {
        ...
        sublink: [
          { name: "Pans", link: "/home" },
          { name: "Tawas", link: "/home" },
          { name: "Pressure Cookers", link: "/home" },
          { name: "Kitchen tools", link: "/home" },
          { name: "Gas Stoves", link: "/home" },
        ],
      },
      {
        Head: "Tableware",
        sublink: [
          { name: "Coffee Mugs", link: "/home" },
          { name: "Dinner Set", link: "/home" },
          { name: "Barware", link: "/home" },
          { name: "Kitchen Storage", link: "/home" },
          { name: "Water Bottles", link: "/home" },
          { name: "Lunch Boxes", link: "/home" },
        ],
      },
      {
        Head: "Furniture",
        sublink: [
          { name: "Beds", link: "/home" },
          { name: "Mattresses", link: "/home" },
          { name: "Wardrobes", link: "/home" },
          { name: "Living Room Furniture", link: "/home" },
          { name: "Sofa", link: "/home" },
          { name: "Sofa Beds", link: "/home" },
        ],
      },
      {
        Head: "More",
        sublink: [
          { name: "TV Units", link: "/home" },
          { name: "Dining Tables & Chairs", link: "/home" },
          { name: "Coffee Tables", link: "/home" },
          { name: "Shoe Racks", link: "/home" },
          { name: "Office & Study Furniture", link: "/home" },
          { name: "Kids Room Furniture", link: "/home" },
        ],
      },
      {
        Head: "Furnishing",
        sublink: [
          { name: "Bedsheets", link: "/home" },
          { name: "Curtains", link: "/home" },
          { name: "Cushions & Pillows", link: "/home" },
          { name: "Blankets", link: "/home" },
          { name: "Bath Towels", link: "/home" },
          { name: "Kitchen & Table Linen", link: "/home" },
        ],
      },
      {
        Head: "Smart Home",
        sublink: [
          { name: "Floor Coverings", link: "/home" },
          { name: "Smart Security System", link: "/home" },
          { name: "Smart Door Locks", link: "/home" },
          { name: "Home Improvement", link: "/home" },
          { name: "Tools & Measuring Equipments", link: "/home" },
          { name: "Home Utilities & Organizers", link: "/home" },
        ],
      },
      {
        Head: "Home Decor",
        sublink: [
          { name: "Paintings", link: "/home" },
          { name: "Clocks", link: "/home" },
          { name: "Wall Shelves", link: "/home" },
          { name: "Stickers", link: "/home" },
          { name: "Showpieces & Figurines", link: "/home" },
          { name: "Home Lighting", link: "/home" },
        ],
      },
      {
        Head: "Home Decor 2",
        sublink: [
          { name: "Bulbs", link: "/home" },
          { name: "Wall Lamp", link: "/home" },
          { name: "Table Lamp", link: "/home" },
          { name: "Ceiling Lamp", link: "/home" },
          { name: "Emergency Lights", link: "/home" },
          { name: "Festive Decor & Gifts", link: "/home" },
        ],
      },
      {
        Head: "Gardening Store",
        sublink: [
          { name: "Stainless Steel Store", link: "/home" },
          { name: "Milton", link: "/home" },
          { name: "Bombay Dyeing", link: "/home" },
          { name: "@home", link: "/home" },
          { name: "HomeTown", link: "/home" },
          { name: "Ajanta", link: "/home" },
        ],
      },
    ],
  },
